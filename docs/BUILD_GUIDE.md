...
`mtulashvili-sre-topology-panel` panel on a single screen:
...
1. **Grafana ≥ 12.0** with the `mtulashvili-sre-topology-panel` plugin installed
...
- **Panel type**: `mtulashvili-sre-topology-panel`
